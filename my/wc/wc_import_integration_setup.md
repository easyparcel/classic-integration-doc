# EasyParcel WooCommerce Integration - Import Version
...
You've successfully set up EasyParcel WooCommerce integration using the Import Version! 

### Next: Checkout [Import woocommerce order fulfilment guides](./wc_import_fulfilment.md)
